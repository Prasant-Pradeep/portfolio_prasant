        ...
        <div className=" mt-10 md:mt-20 flex flex-col gap-20">
          {portfolioProjects.map((project) => (
            <div 
              ...
              20 px-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 after:pointer-events-none"
            >
              ...
              <a href={project.link}>
                <button className="bg-white text-gray-950 h12 w-full
                md:w-auto px-8 rounded-xl font-semibold inline-flex items-center
